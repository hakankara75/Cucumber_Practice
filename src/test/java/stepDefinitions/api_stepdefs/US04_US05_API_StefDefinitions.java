...
public class US04_US05_API_StefDefinitions {
    ...
    public void bosVeriIleDeanBodysiEkleyemedigiAPIIleDogrulanir(String no,String name, String surname, String birthPlace, String birthDay, String gender, String phoneNumber, String ssn, String username, String password) {
        ...
        if(username.equals("")){
            ...
            username= faker.idNumber().ssnValid();
        }
        if(password.equals("")){
            password= "";
        }else {
        ...
        String expectedGender2= "You have entered an invalid value. Valid values are: MALE, FEMALE";
        ...
        String expectedSsn2= "Please enter valid SSN number";

        String expectedPassword= "Please enter your password as at least 8 characters";
        String expectedPassword2= "Please enter your password as at least 8 characters";
        ...
        switch (no){
            case "1":    String actualName= jsonPath.get("validations.name").toString();
            ...
            case "2":
                ...
                break;
            case "3":   String actualBirthPlace= jsonPath.get("validations.birthPlace").toString();
                ...
                break;
            case "4":    String actualGender= jsonPath.get("validations.gender").toString();
                ...
                }else {                    assertEquals(expectedGender2, jsonPath.get("validations.gender").toString());
            ...
            case "5":
                ...
                }else {                    assertEquals(expectedBirthDay2, jsonPath.get("validations.birthDay").toString());
                };
                break;
            case "6":   String actualPhoneNumber= jsonPath.get("validations.phoneNumber").toString();
                ...
                }else {                    assertEquals(expectedPhoneNumber2, jsonPath.get("validations.phoneNumber").toString());
                };
                break;
            case "7":  String actualSsn= jsonPath.get("validations.ssn").toString();
                ...
                }else {                    assertEquals(expectedSsn2, jsonPath.get("validations.ssn").toString());
                };
                break;
            case "8":  String actualUsername= jsonPath.get("validations.username").toString();
                ...
                }else {                    assertEquals(expectedUsername2, jsonPath.get("validations.username").toString());
                };
                break;
            case "9":  String actualPassword= jsonPath.get("validations.phoneNumber").toString();
                ...
                }else {                    assertEquals(expectedPassword2, jsonPath.get("validations.password").toString());
                };
                break;
                default:
                    break;
